...
def airline_func_rus(airline_name, selectSentiment):
    try:
        ...
        # ====================================  stop to DATA CLEANING   =======================================


        # ====================================  starting to analyze sentiment choice  =======================================
        ...
        # Function to generate bar chart of word frequencies based on selected sentiment
        def generate_word_freq_chart(sentiment_filter):
            nonlocal most_common_words, words, frequencies  # Access the variables in the parent scope
            ...
            custom_stopwords = stopwords.words('russian')
